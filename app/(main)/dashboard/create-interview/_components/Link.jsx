...
const Link = ({ interviewId, formData }) => {
    ...
    <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl border border-gray-100 p-6 space-y-5">
      ...
      <div className="bg-white rounded-2xl p-4 border border-gray-100 shadow-lg space-y-3">
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <Button 
            variant="outline" 
            className="h-12 border-2 border-gray-200 hover:border-emerald-300 hover:bg-emerald-50 transition-all duration-200 flex items-center justify-center gap-2 font-medium"
          >
      ...
      <div className="flex justify-between items-center pt-2">
        <Button 
          variant="outline" 
          className="flex items-center gap-2 px-6 py-3 border-2 border-gray-300 hover:border-gray-400 hover:bg-gray-50 transition-all duration-200 rounded-xl font-medium"
        >
