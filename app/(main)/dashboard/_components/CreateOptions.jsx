...
const CreateOptions = () => {
    ...
    const goToInterview = () => router.push('/dashboard/create-interview');
    ...
    return (
        <div
            ...
            <div
                onClick={goToInterview}
                className='shadow-md border-gray-200 hover:bg-teal-100 transition-colors cursor-pointer bg-gray-50 p-4 rounded-lg'>
